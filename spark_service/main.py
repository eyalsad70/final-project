...
from message_handler import spark_process_message
...
if __name__ == "__main__":
   logger.info("Staring SPARK Service")
   poll_and_process_messages(kfk.TRANSFORMER_TOPIC_NAME, spark_process_message)
